...
struct InConversationPresenter: ViewModifier {
...
extension View {
	func inConversationPresenter(
		viewModel: ConversationViewModel?,
		focusCoordinator: FocusCoordinator,
		insetsTopSafeArea: Bool,
		sidebarColumnWidth: Binding<CGFloat>
	) -> some View {
		modifier(InConversationPresenter(
			viewModel: viewModel,
			focusCoordinator: focusCoordinator,
			insetsTopSafeArea: insetsTopSafeArea,
			sidebarColumnWidth: sidebarColumnWidth
